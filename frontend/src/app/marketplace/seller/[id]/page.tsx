  ...
  if (!seller) return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8F6F0]">
      <div className="text-center">
        ...
        <button onClick={() => router.push("/marketplace")} className="mt-4 text-[#2B4C3B] font-bold underline">Kembali</button>
      </div>
    </div>
  );
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
              {products.map((p, i) => (
                <motion.div
                  ...
                  onClick={p.stock > 0 ? () => router.push(`/marketplace/product/${p.id}`) : undefined}
