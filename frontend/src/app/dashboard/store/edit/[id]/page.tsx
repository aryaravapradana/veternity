...
export default function EditProductPage() {
  ...
  const loadProductData = async () => {
    ...
    try {
      ...
      // We don't restore AI grade from DB here because the schema might not have it in the same format yet,
      // but if the user uploads a new image, it will trigger the grade check again.
